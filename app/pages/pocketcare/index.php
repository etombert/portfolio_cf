    <?php include '../../head.php';?>
		...
		<main class="project pocketcare animsition" data-animsition-in-class="fade-in" data-animsition-in-duration="1000" data-animsition-out-class="fade-out" data-animsition-out-duration="800">
			<section class="section-1">

                <div class="bloc-container">
                    <div class="bloc-text">
                        <h2 title="Pocketcare">Pocketcare</h2>
                        ...
                        <div class="bloc-arrow">
                            <div id="scroll-down-container">
                                <div id="arrow-down">
                                    <svg width="10px" height="60px" y="-6.242326819299771"><polygon points="4,0 6,0 6,55 10,55 5,60 0,55 4,55" fill="#000000"></polygon>		</svg>
                                    <svg width="10px" height="60px" y="-71.74539609157986"><polygon points="4,0 6,0 6,55 10,55 5,60 0,55 4,55" fill="#000000"></polygon>		</svg>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bloc-img">
                        <img src="../../src/images/pocketcare/IMG-header-pocketcare.png" alt="Pocketcare header">
                    </div>
                </div>
			...
			<section class="section-2">
                <div class="bloc-img">
                    <img src="../../src/images/pocketcare/IMG-onboarding.png" alt="Onboarding">
                </div>
            </section>
            ...
            <section class="section-3">
                ...
                <div class="bloc-content">
                    <div class="bloc-img">
                        <img src="../../src/images/pocketcare/IMG-header-pocketcare.png" alt="Pocketcare headeer">
                        <video src="../../src/images/pocketcare/video/1-onboarding.mp4" loop autoplay></video>
                    </div>

                    <div class="bloc-text">
                        <h3 title="YOUR HEALTH IS PRECIOUS">YOUR HEALTH IS PRECIOUS</h3>
            ...
            <section class="section-4">
                <div class="bloc-img">
                    <img src="../../src/images/pocketcare/IMG-rappel-medocs.png" alt="Rappel médicaments">
                </div>
            </section>
            ...
            <section class="section-5">
                <div class="bloc-content">
                    ...
                    <div class="bloc-text">
                        <h3 title="TAKE YOUR MEDICINE PROPERLY">TAKE YOUR MEDICINE PROPERLY</h3>
            ...
            <section class="section-6">
                <div class="bloc-content">
                    ...
                    <div class="bloc-text">
                        <h3 title="AGAINST FORGETTING MEDICINES">AGAINST FORGETTING MEDICINES</h3>
                    ...
                    <div class="bloc-img">
                        <img src="../../src/images/pocketcare/IMG-rappel-medocs-2.png" alt="Rappel médicament">
                    </div>
            ...
            <section class="section-7">
                <div class="bloc-content">
                    ...
                    <div class="bloc-text">
                        <h3 title="AN ESSENTIAL MEDICAL WALLET">AN ESSENTIAL MEDICAL WALLET</h3>
            ...
            <section class="section-8">
                <div class="bloc-img">
                    <img src="../../src/images/pocketcare/IMG-ordonnances.png" alt="Ordonnances">
                </div>
            </section>
            ...
            <section class="section-9">
                <div class="bloc-content">
                    <div class="bloc-img">
                        <img src="../../src/images/pocketcare/IMG-header-pocketcare.png" alt="Header pocketcare">
                        <video src="../../src/images/pocketcare/video/4-ordonnances.mp4" loop autoplay></video>
                    </div>

                    <div class="bloc-text">
                        <h3 title="MINIMIZE MEDICAL ERRORS">MINIMIZE MEDICAL ERRORS</h3>
            ...
            <section class="section-10">
                <div class="bloc-img">
                    <img src="../../src/images/pocketcare/IMG-gestion-famille.png" alt="Gestion famille">
                </div>
            </section>
            ...
            <section class="section-11">
                <div class="bloc-text">
                    <h3 title="YOUR HEALTH ALWAYS AT YOUR FINGERTIPS">YOUR HEALTH ALWAYS AT YOUR FINGERTIPS</h3>
            ...
            <section class="section-12 parallax-window" data-parallax="scroll" data-image-src="../../src/images/pocketcare/IMG-footer-Pocketcare.png"></section>
